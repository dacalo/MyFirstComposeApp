...
fun MyColumn(modifier: Modifier = Modifier){
    Column(
        ...
        //Text("Hola 2", modifier = Modifier.background(Color.Green).weight(1f))
        //Text("Hola 3", modifier = Modifier.background(Color.Blue).weight(1f))
        //Text("Hola 4", modifier = Modifier.background(Color.Yellow).weight(1f))
